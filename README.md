...
My background is blue team: detection, monitoring, threat hunting. I came into this project knowing how to defend but not really knowing how to think like the person I was defending against, and building the attack simulation engine changed that. Writing the code that enumerated IAM, read S3 buckets it shouldn't, and tried to assume roles made me see my AWS environment very differently. Python and Boto3 got a lot more natural too. This was the first time I was building a proper multi-module project rather than just scripts, and I was still Googling AWS CLI commands mid-project just to double-check I had the syntax right. This was quite the learning experience.
